...
export default function PostEventLinksManchester() {
  return (
    <main>
      <Helmet>
        <title>Event Links - Manchester | Queer in Tech</title>
        <meta name="description" content="Links and resources from Queer in Tech Manchester events. RSVP, submit talk ideas, and connect with the community." />
      </Helmet>
